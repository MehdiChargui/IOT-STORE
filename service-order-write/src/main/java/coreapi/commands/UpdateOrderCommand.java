...
public class UpdateOrderCommand extends BaseCommand<String>{
    ...
    public UpdateOrderCommand(String id, String reference, String customer, String deliveryAddress, String deliveryMethod, String paymentMethod, String status,Boolean paymentStatus, double total, double totalTTC, List<Details> details) {
        super(id);
