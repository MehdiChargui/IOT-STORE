...
public class UpdateCustomerCommand extends BaseCommand<String>{
    ...
    public UpdateCustomerCommand(String id, String firstname, String lastname, String phoneNumber, List<Address> addresses, String function, String mail, String login, String password, Boolean active, Boolean deleted) {
        super(id);
