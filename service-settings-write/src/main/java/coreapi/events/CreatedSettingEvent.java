...
public class CreatedSettingEvent extends BaseEvent<String> {
    @Getter private String description;
    @Getter private List<MailList> mailList;
    @Getter private List<Links> links;

    public CreatedSettingEvent(String id, String description, List<MailList> mailLists, List<Links> links) {
        super(id);
