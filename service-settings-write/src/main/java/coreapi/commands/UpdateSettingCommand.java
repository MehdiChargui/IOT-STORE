...
public class UpdateSettingCommand extends BaseCommand<String>{
    @Getter private String description;
    @Getter private List<MailList> mailList;
    @Getter private List<Links> links;

    public UpdateSettingCommand(String id, String description, List<MailList> mailLists, List<Links> links) {
        super(id);
