...
public class CreatedOrderEvent extends BaseEvent<String> {
    ...
    public CreatedOrderEvent(String id, String reference, Date orderDate, String customer, String deliveryAddress, String deliveryMethod, String paymentMethod, String status, Boolean paymentStatus, double total, double totalTTC, List<Details> details) {
        super(id);
