...
public class CreateCustomerCommand extends BaseCommand<String>{
    ...
    public CreateCustomerCommand(String id, String firstname, String lastname, String mail, String login, String password, Date registrationDate, Boolean mailVerified, String accountType, Boolean active, Boolean deleted) {
        super(id);
